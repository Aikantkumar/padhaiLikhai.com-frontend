        ...
        <>
            <div className="registerteacher h-[80vh] bg-[#0D0D0D]">
                <div className='flex items-center gap-5 mb-[70px]'>
                    <div className='text-[120px] text-[#B8A895] tracking-[-10px] font-semibold pl-[15vw] flex flex-col items-end'>
                    ...
                    <div className='text-[50px] tracking-[-3px] font-bold'>
                        <div className='text-[#B8A895] mb-[-25px]'>Lorem ipsum dolor sit amet</div>
            ...
            <div className="allcourses bg-white h-screen">
                <div className="coursepage1 flex flex-row h-screen">
                    <div className=' w-[60vw]  p-[20px]'>
                        ...
                        <div className="img h-[350px]  bg-yellow-300"></div>
                        <div className="txt">
                            <div className='text-[50px] tracking-[-3px] font-bold'>Class 6-8</div>
                    ...
                    <div className='w-[40vw]  p-[20px]'>
                        ...
                        <div className="txt mb-[70px]">
                            <div className='text-[50px] tracking-[-3px] font-bold'>Class 9-10</div>
                            <div>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Saepe, cumque</div>
                        </div>
